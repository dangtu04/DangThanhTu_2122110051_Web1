                  ...
                  <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                     ...
                     <td><?php echo e($row->delivery_name); ?></td>                  
                      ...
                      <td><?php echo e($row->delivery_email); ?></td>
                      <td><?php echo e($row->delivery_phone); ?></td>
                      <td><?php echo e($row->delivery_address); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DangThanhTu_Laravel_W1\resources\views/backend/order/index.blade.php ENDPATH**/ ?>