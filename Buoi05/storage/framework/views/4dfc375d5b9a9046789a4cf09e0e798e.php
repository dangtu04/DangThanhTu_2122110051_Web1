  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo e(asset('image/nguyenvancut.jpg')); ?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">DangThanhTu</a>
        </div>
      </div>
      <nav class="mt-2">
...
</html><?php /**PATH D:\xampp\htdocs\DangThanhTu_Laravel_W1\resources\views/layouts/admin.blade.php ENDPATH**/ ?>