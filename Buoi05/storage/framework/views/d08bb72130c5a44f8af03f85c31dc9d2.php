            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-12 text-right">
                        ...
                        <a class="btn btn-sm btn-info" href="<?php echo e(route('admin.product.index')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" value="<?php echo e(old('price')); ?>" name="price" id="price" class="form-control">
                        </div>
                        <div class="mb-3">
                            <label for="pricesale">Giá khuyến mãi</label>
                            <input type="number" value="<?php echo e(old('pricesale')); ?>" name="pricesale" id="pricesale" class="form-control">
                        </div>
                        <div class="mb-3">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DangThanhTu_Laravel_W1\resources\views/backend/product/create.blade.php ENDPATH**/ ?>