        ...
        <div class="card-header">
            <div class="row">
              <div class="col-12 text-right">
                <a href="<?php echo e(route('admin.post.create')); ?>" class="btn btn-success"><i class="fas fa-plus"></i> Thêm bài viết</a>
                ...
                <tbody>
                  <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      ...
                      <td class="text-center"><img src="<?php echo e(asset('images/posts/'.$row->image)); ?>" 
                        style="width: 100px" alt="<?php echo e($row->image); ?>"></td>
                      <td><?php echo e($row->title); ?></td>                  
                      <td><?php echo e($row->topicname); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DangThanhTu_Laravel_W1\resources\views/backend/post/index.blade.php ENDPATH**/ ?>